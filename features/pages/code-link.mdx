---
title: "Code Link"
description: "A web URL to a code, its rewards, and instructions on how to use it. The code can be an affiliate, referral, or promo code."
---
...
The promo code link can be constructed by following the usual format `https://<subdomain>.wwk.link/<promo-code>`.
