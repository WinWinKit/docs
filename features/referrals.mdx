---
title: "Referrals"
description: "A referral program defines the rewards that users receive for inviting others and being invited."
---

![Programs](/images/referrals-table.png)
...
<Warning>
  ...
  to the `is_premium` property for users. Read more about [Users](/users/users).
</Warning>
...
<Info>
  ...
  Program](/referrals/referrals#3-rewards-for-the-invited-user) below.
</Info>
...
<Info>
  Following example assumes there are appropriate rewards configured. Learn more
  about [Rewards](/rewards/introduction).
</Info>
