...
**App Store Connect API** related error codes.

| Status | Code | Description |
|:-------|:-----|:------------|
| 401 | APP_STORE_CONNECT.UNAUTHORIZED | Unauthorized to perform the request or the auth key has been revoked. |
| 404 | APP_STORE_CONNECT.NOT_FOUND | Resource not found. |
| 500 | APP_STORE_CONNECT.OTHER | Other error has occured. |
| 500 | APP_STORE_CONNECT.ERROR | Internal server error on the App Store Connect side. |
