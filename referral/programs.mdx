...
For **the referrling user**, activate the reward when invited user(s) claim the referral code and then become premium.
...
<Warning>
Using **Conversion** activation requires continious updates of `is_premium` property for users. Read more about [Users](/referral/users).
</Warning>
