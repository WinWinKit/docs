...
[Read more about Rewards](/referral/rewards)
...
Enter the name and optionally description.
...
[Read more about Programs](/referral/programs)
...
<Warning>
The SDK provide interface for interacting with WinWinKit APIs, but not the UI.
